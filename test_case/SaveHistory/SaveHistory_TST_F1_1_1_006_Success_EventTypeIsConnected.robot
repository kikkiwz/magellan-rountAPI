...
*** Test Cases ***
################### Post ###################
SaveHistory_TST_F1_1_1_006_Success_EventTypeIsConnected 
	...
	#Body
    ${body}=    Evaluate    {"ThingInfo":{"ThingId":"${ThingIdArr}[0]","ThingName":"${ThingName}","ICCID":"${ICCID}","IMEI":"${IMEI}","QuasarContentType":"${VALUE_SAVEHISTORY_QUASARCONTENTTYPE_REFRESH}","QuasarRefreshTime":"${VALUE_SAVEHISTORY_QUASARREFRESHTIME_0}"},"EventType":"${VALUE_SAVEHISTORY_EVENTTYPE_CONNECTED}","Sensors":{"GPS":"${VALUE_SAVEHISTORY_GPS}"},"Timestamp":${current_timestamp}}
