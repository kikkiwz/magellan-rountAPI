...
*** Test Cases ***
################### Post ###################
SaveHistory_TST_F1_0_3_005_Error_ThingIDNotFount 
	...
	#Body
    ${body}=    Evaluate    {"ThingInfo":{"ThingId":"${ThingIdArr}[0]${VALUE_SAVEHISTORY_THINGIDINVALID}","ThingName":"${ThingName}","ICCID":"${ICCID}","IMEI":"${IMEI}","QuasarContentType":"${VALUE_SAVEHISTORY_QUASARCONTENTTYPE_REFRESH}","QuasarRefreshTime":"${VALUE_SAVEHISTORY_QUASARREFRESHTIME_0}"},"EventType":"${VALUE_SAVEHISTORY_EVENTTYPE_REPORT}","Sensors":{"GPS":"${VALUE_SAVEHISTORY_GPS}"},"Timestamp":${current_timestamp}}
